<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="TestTreeJQuery.SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" TestTreeJQuery.Model.SchedulerAppointment"
        TypeName=" TestTreeJQuery.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" TestTreeJQuery.Model.SchedulerResource"
        TypeName=" TestTreeJQuery.Model.ResourceDataSourceHelper"
